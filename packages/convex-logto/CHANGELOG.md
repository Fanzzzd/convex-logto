...
- [#246](https://github.com/Fanzzzd/convex-logto/pull/246) [`4996adc`](https://github.com/Fanzzzd/convex-logto/commit/4996adc65a52e4ab1a8313f99468d7ac14132c97) Thanks [@Fanzzzd](https://github.com/Fanzzzd)! - Prose-only release. Session mode is now the documented default. The npm README
...
- [#244](https://github.com/Fanzzzd/convex-logto/pull/244) [`bffc14f`](https://github.com/Fanzzzd/convex-logto/commit/bffc14f4eb35f380172e5b679fac06181810c6c3) Thanks [@Fanzzzd](https://github.com/Fanzzzd)! - Session mode: a `signIn()` started while a `signOut()` is in flight now waits for it, and starts nothing once the page is on its way to Logto's end-session endpoint.
